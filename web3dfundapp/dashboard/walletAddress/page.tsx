...
import { FundingFactory } from "@/app/constants/contracts";
...
const CreateCampaignModal = (
    ...
    // Deploy contract from FundingFactory
    const handleDeployContract = async () => {
        ...
        try {
            ...
            const contractAddress = await deployPublishedContract({
                ...
                chain: baseSepolia,
                account: account!,
                contractId: "DecentralizedFunding",
                contractParams: [
                    campaignName,
                    campaignDescription,
                    campaignGoal,
                ...
                publisher: "0x5292dE738dc617FeA6c3D92bE269181b526C3b28",
                version: "1.1.0",
            });
